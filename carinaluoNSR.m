...
figure; 
plot(freq,spec); 
set(gca, 'XDir','reverse','FontSize', 14,'FontName','Times New Roman')
xlim([2070,2120])
xlabel('Frequency (Hz)','FontSize',20,'FontName','Times New Roman');
ylabel('Peak Intensity (arbitrary units)','Color', 'black','FontName', 'Times New Roman','FontSize',20)
title('1D Spectrum','FontSize',30,'FontName','Times New Roman','FontWeight', 'bold');
...
hold off 
annotation('textbox', [0.3, 0.02, 0.4, 0.05], 'String', 'Time (\museconds)', 'HorizontalAlignment', 'center', 'EdgeColor', 'none','FontSize', 24,'FontName', 'Times New Roman');
...
title('T1 Inversion Recovery','FontSize',30,'FontName','Times New Roman')
hold on
plot(T1_time,T1_int_peak1, 'b','DisplayName', 'Peak 1')
plot(T1_time,T1_int_peak2, 'r','DisplayName', 'Peak 2')
...
%Add these fits to the plot
plot(fit_T1_peak1, '--b')
plot(fit_T1_peak2, '--r')
legend('T1 Peak 1','T1 Peak 2','Location', 'best','FontSize',24,'FontName','Times New Roman');
hold off
xlabel('Time (seconds)','FontSize',24,'FontName','Times New Roman')
ylabel('Signal Intensity (arbitrary units)','FontSize',24,'FontName','Times New Roman')
...
figure;
set(gca,'FontSize', 14,'FontName','Times New Roman')
title('T2 Spin Echo','FontSize',30,'FontName','Times New Roman')
hold on
plot(T2_time,T2_int_peak1, 'b','DisplayName', 'Peak 1')
plot(T2_time,T2_int_peak2, 'r','DisplayName', 'Peak 2')
